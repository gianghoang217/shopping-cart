      ...
      <div className="flex gap-3 items-center border-b-1 border-b-gray-300">
        ...
        <div>
          <div className="relative flex items-center max-w-[8rem]">
            <button
              onClick={() => handleChangeQuantity(currentQuantity - 1)}
              type="button"
              id="decrement-button"
              data-input-counter-decrement="quantity-input"
              className="bg-gray-100    hover:bg-gray-200 border border-gray-300 rounded-s-lg p-3 h-11 focus:ring-gray-100 -gray-700 focus:ring-2 focus:outline-none"
            >
              <svg
            ...
            <input
              ...
              className="border-y-1 bg-gray-50 border-x-0 border-y-gray-300 h-11 text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full py-2.5   -400  -blue-500 -blue-500"
            ...
            <button
              ...
              className="bg-gray-100    hover:bg-gray-200 border border-gray-300 rounded-e-lg p-3 h-11 focus:ring-gray-100 -gray-700 focus:ring-2 focus:outline-none"
            >
              <svg
                className="w-3 h-3 text-gray-900 "
                aria-hidden="true"
        ...
        <button className="ml-auto w-1/12 w-[30px] h-[30px] text-white rounded-4xl bg-gray-500 flex items-center justify-center">
          X
        </button>
      </div>
    </div>
